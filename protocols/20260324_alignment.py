...
res, zheavymodel = align.zheavy_center(experiment, (-2.0, 2.0), 31, entry.sampleposition,
                                       zheavymodel,
                                       scan_dir)
start_z = res["center"]
...
# determine more precise updated vertical position (pitch should be unaffected)
res, zheavymodel = align.zheavy_center(experiment, (-2*beam_sigma, 2*beam_sigma), 31,
                                 entry.sampleposition, zheavymodel, scan_dir)
entry.sampleposition["zheavy"] = res["center"]
